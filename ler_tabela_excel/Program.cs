    ...
    class Program
    {
        public static void Main(string[] args)
        {
            try
            {
                ...
                var tabela = new XLWorkbook(@"C:\Users\veron\Documents\Repositorios\ler-tabela-excel\massa_teste\bairro-taxa.xlsx"); //coloca o caminho da pasta com o arquivo XLSM do EXCEL
                ...
                var linha = 2; //Começar da linha 2
                while (true)
                {
